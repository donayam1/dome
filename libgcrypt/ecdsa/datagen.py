...
def genECDSAData(ndata=3000, out_dir="data/ecdsa/round1/input", key_length=3000, file_name_prefix=["private_key_"],base_dir=""):
    os.makedirs(out_dir, exist_ok=True)          
    # print("curr_dir=",os.getcwd())     
    binary_path = os.path.join(f"{base_dir}","ecdsa","datagen")     
