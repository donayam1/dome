...
//     err = gcry_mpi_aprint(GCRYMPI_FMT_HEX, &hex_buffer, &hex_size, mpi);
//     if (err)
//     {
//         std::cerr << "Failed to print MPI: " << gcry_strerror(err) << std::endl;
//         exit(1);
//     }

//     std::cout << label << ": " << hex_buffer << std::endl;
//     gcry_free(hex_buffer);
// }

// // Helper function to print the ciphertext
// void print_ciphertext(gcry_sexp_t ciphertext)
// {
//     // Extract the ciphertext MPI
//     gcry_mpi_t mpi_ciphertext = gcry_sexp_nth_mpi(ciphertext, 0, GCRYMPI_FMT_USG);
//     if (!mpi_ciphertext)
//     {
//         std::cerr << "Failed to extract ciphertext MPI" << std::endl;
//         exit(1);
//     }

//     print_mpi_hex("Ciphertext", mpi_ciphertext);
